    ...
    <div class="container-ct">
        <div class="Contract-ct">
            ...
            <div class="Contract-ct-input-container mb-6">
                ...
                <input type="text" id="nameCT" placeholder="ชื่อของคุณ" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="Contract-ct-input-container mb-6">
                <label for="email" class="mb-2">
                    อีเมล
                </label>
                <input type="email" id="email" placeholder="กรอกอีเมลของคุณ" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="Contract-ct-input-container-rr mb-6">
                <label for="text" class="mb-2">
                    เรื่อง
                </label>
                <input type="text" id="subject" placeholder="เรื่อง" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="Contract-ct-input-container-r mb-6">
                <label class="mb-2">
                    ข้อความ
                </label>
                <textarea class="textarea textarea-info text-base h-24" id="message" placeholder="ข้อความ..."></textarea>
            </div>
