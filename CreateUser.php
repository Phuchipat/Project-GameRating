    ...
    <div class="container">
        <div class="cr-ac">
            ...
            <div class="input-container mb-6">
                ...
                <input type="username" id="username" placeholder="ชื่อบัญชี (สูงสุด 20 ตัวอักษร)" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="input-container mb-6">
                ...
                <input type="email" id="email" placeholder="อีเมล (example@hotmail.com)" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="input-container mb-6">
                ...
                <input type="date" id="birthdate" class="input input-bordered input-info text-white w-full h-11 max-w-auto" onclick="showDatePicker()" />
            </div>
            <div class="input-container mb-6">
                <p class="mb-2">รหัสผ่าน<span class="red-asterisk">*</span></p>
                <!-- <input type="password" id="password" name="password" placeholder="รหัสผ่าน"> -->
                <input type="password" id="password" placeholder="รหัสผ่าน" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="input-container mb-6">
                ...
                <input type="password" id="confirm-password" placeholder="ยืนยันรหัสผ่าน" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
