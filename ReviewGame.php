        ...
        <div class="row row-1">
            ...
            <div class="col col-2">
                ...
                <div class="centerScore">
                    <div class="mainScore" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="--value:37">
                    </div>
                </div>
            </div>
            <div class="col col-3">
                <div class="rowOne">
                    ...
                    <div class="Score3" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="--value:37"></div>
                </div>
                <div class="rowTwo">
            ...
            <div class="col col-4">
                <div class="count-review-review">
                    ...
                    <div class="re-cou-po text-2xl">
                        <button class="write-post-review-button btn text-xl" id="write-post-review-buttonID">สร้างโพสต์รีวิว</button>
        ...
        <div class="row row-4">
                ...
                <div class="con-review">
                    <div class="header-left-con-review">
                        ...
                        <div class="dropdownBox dropdown dropdown-bottom ml-auto">
                            ...
                            <ul tabindex="0" class="dropdown-content z-[1] menu p-1 shadow rounded-box -ml-5 -mt-5 bg-[#e2384f] group hover:bg-[#dd1933]">
                                <li><a>รายงาน</a></li>
                            </ul>
                        </div>

                    </div>
                    <textarea id="userReview-con-review" rows="3" cols="65" placeholder="ข้อความเขียนรีวิว....." readonly></textarea>

                    <div class="container container-score-review">
                        <div class="col-content-review col-content-1-review">
                            <!-- Content of Col 1 -->
                            <p>คะแนนเกม</p>
                            <div class="ScoreShowReview" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="--value:38"></div>
                        </div>
            ...
            <div class="col col-8">
                ...
                <div class="con-review-p">
                    ...
                    <textarea id="userReview-con-review-p" rows="3" cols="65" placeholder="ข้อความเขียนรีวิว....." readonly></textarea>
                    ...
                    <textarea id="userReview-con-review-p-user-comment" rows="3" cols="65" placeholder="ความคิดเห็น....." readonly></textarea>
            ...
            <div class="container-footer-rg">
                ...
                <div class="main-box-rp">
                    <div class="review-input">
                        <p>เขียนรีวิว</p>
                        <textarea class="review-input-text-rp" id="review-text-rp" name="review-text" placeholder="เขียนรีวิวของคุณ..."></textarea>
                    </div>
                    <div class="rating-rg">
                ...
                <div class="main-box-post">
                    <div class="review-input-post">
                        <p>เขียนโพสต์รีวิว</p>
                        <textarea class="review-input-text-post" id="review-text" name="review-text" placeholder="เขียนโพสต์รีวิวของคุณ..."></textarea>
                    </div>
                ...
                <div class="con-review-comment bg-base-100">
                    <div class="rowComent">
                        <div class="colComent1 bg-base-200">
                            ...
                            <button class="CloseWindowsComent btn btn-outline text-lg" id="hideComments">ปิดหน้าต่าง</button>
                        </div>
                    </div>
                    <!-- <div class="rowComent">
                            ...
                            <div class="containerAuthor">
                                ...
                                <div class="rowAuthor">
                                    <div class="colAuthor4">
                                        <textarea id="userReview-con-review-p-c" rows="3" cols="65" placeholder="ข้อความเขียนรีวิว....."></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="containerAuthor">
                                ...
                                <div class="rowAuthor">
                                    <div class="colAuthor6">
                                        <textarea id="userReview-con-review-p-c" rows="3" cols="65" placeholder="ข้อความเขียนรีวิว....." readonly></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
