        ...
        <div class="row">
            <div class="col3">
                <div class="container add-category">
                    ...
                    <input type="text" id="AddCategory" placeholder="เพิ่มหมวดหมู่เรตติ้งเกม" class="input input-bordered input-info w-full max-w-xs" />
                ...
                <div class="container edit-category">
                    ...
                    <p class="text-lg">หมวดหมู่เรตติ้งเกม</p>
                    <input type="text" id="EditCategory" placeholder="หมวดหมู่เรตติ้งเกม" class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    ...
                    <select class="select select-bordered bg-[#fff] w-full max-w-xs text-black text-lg" id="EditSeclect">
                    ...
                    <input type="text" id="DescCategory" placeholder="หมวดหมู่เรตติ้งเกม" class="input input-bordered input-info w-full max-w-xs" />
                ...
                <div class="container delete-category">
                    ...
                    <input type="text" id="DeleteCategory" placeholder="ลบหมวดหมู่เรตติ้งเกม" class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    <datalist id="gameCategory">
                        <option value="E"></option>
                        <option value="M"></option>
                        <option value="asdf"></option>
