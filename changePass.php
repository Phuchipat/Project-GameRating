    ...
    <div class="container-cp">
        <form class="change-password-form">
            ...
            <div class="form-group mb-6">
                ...
                <input type="password" id="current-password" placeholder="กรอกรหัสผ่านปัจจุบัน" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="form-group mb-6">
                <label class="mb-2" for="new-password">รหัสผ่านใหม่</label>
                <input type="password" id="new-password" placeholder="กรอกรหัสผ่านใหม่" class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="form-group mb-6">
