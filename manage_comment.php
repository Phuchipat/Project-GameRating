    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                ...
                <li><a href="manage_comment.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการความคิดเห็น</a></li>
                    ...
                    <table class="table text-lg">
                        ...
                        <thead>
                            <tr class="text-lg tableHeaders">
                                ...
                                <th class="tableHeadersDate">สถานะ</th>
                                <th>ลบความคิดเห็น</th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="avatar">
                                            <div class="mask mask-squircle w-12 h-12">
                                                <img src="https://s.isanook.com/ca/0/ud/279/1395057/008.jpg?ip/resize/w728/q80/jpg" />
                                            </div>
                                        </div>
                                        <div>
