        ...
        <div class="row">
            <div class="col3">
                ...
                <div class="container edit-category">
                    ...
                    <input type="text" id="EditCategory" placeholder="ประเด็น" class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    ...
                    <input type="text" id="DescCategory" placeholder="แก้ไขชื่อประเด็น" class="input input-bordered input-info w-full max-w-xs" />
                ...
                <div class="container delete-category">
                    ...
                    <input type="text" id="DeleteCategory" placeholder="ลบประเด็นรีวิว" class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    <datalist id="gameCategory">
                        <option value="แอ็กชั่น"></option>
                        <option value="ผู้เล่นคนเดียว"></option>
                        <option value="กีฬา"></option>
